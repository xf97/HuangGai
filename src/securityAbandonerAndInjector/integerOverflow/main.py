...
#源代码保存路径
CONTRACT_PATH = "../../contractExtractor/integerOverflowExtractor/result"
#注入信息保存路径
INJECT_INFO_PATH = "../../contractExtractor/integerOverflowExtractor/injectInfo"
#sol文件后缀
SOL_SUFFIX = ".sol"
#json.ast文件后缀
JSON_AST_SUFFIX = "_json.ast"

from integerOverflowInjector import integerOverflowInjector	#注入器
import os
import time
...
if __name__ == "__main__":
	io = integerOverflow(INJECT_INFO_PATH, CONTRACT_PATH)
	io.run()
