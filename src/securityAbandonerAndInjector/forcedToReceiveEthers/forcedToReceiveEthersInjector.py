...
#合约结果命名后缀
INJECTED_CONTRACT_SUFFIX = "_forcedToReceiveEthers.sol"
#标记文件命名后缀
INJECTED_INFO_SUFFIX = "_forcedToReceiveEthersInfo.txt"
#结果保存路径
DATASET_PATH = "./dataset/"
#插入标记字符串
INJECTED_FLAG = "\t//inject FORCED TO RECEIVE ETHERS"
#整体存款语句
...
class forcedToReceiveEthersInjector:
	...
	def inject(self):
		...
		for item in self.info[SRC_KEY]:
			srcAndItsStr[item[0]] = [item[1], CONTRACT_BALANCE_STR]
			#然后在尾部添加标记语句
			endPos = item[1]
