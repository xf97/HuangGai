...
#合约结果命名后缀
INJECTED_CONTRACT_SUFFIX = "_specifyFuncVarAnyType.sol"
#标记文件命名后缀
INJECTED_INFO_SUFFIX = "_specifyFuncVarAnyTypeInfo.txt"
#结果保存路径
DATASET_PATH = "./dataset/"
#插入标记字符串
INJECTED_FLAG = "\t//inject SPECIFY FUNC VAR AS ANY TYPE"
#保存注入信息的字典键值
SRC_KEY = "srcPosAndStr"



class specifyFuncVarAnyTypeInjector:
