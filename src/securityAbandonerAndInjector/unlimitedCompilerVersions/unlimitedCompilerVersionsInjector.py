...
#合约结果命名后缀
INJECTED_CONTRACT_SUFFIX = "_unlimitedCompilerVersions.sol"
#标记文件命名后缀
INJECTED_INFO_SUFFIX = "_unlimitedCompilerVersionsInfo.txt"
#结果保存路径
DATASET_PATH = "./dataset/"
#插入标记字符串
INJECTED_FLAG = "\t//inject UNLIMITED COMPILER VERSIONS"
#保存注入信息的字典键值
SRC_KEY = "srcPos"


class unlimitedCompilerVersionsInjector:
