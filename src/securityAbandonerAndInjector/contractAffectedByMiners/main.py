...
#源代码保存路径
CONTRACT_PATH = "../../contractExtractor/contractAffectedByMinersExtractor/result"
#注入信息保存路径
INJECT_INFO_PATH = "../../contractExtractor/contractAffectedByMinersExtractor/injectInfo"
#sol文件后缀
SOL_SUFFIX = ".sol"
#json.ast文件后缀
JSON_AST_SUFFIX = "_json.ast"

from contractAffectedByMinersInjector import contractAffectedByMinersInjector	#注入器
import os
import time

class contractAffectedByMiners:
...
if __name__ == "__main__":
	cabm = contractAffectedByMiners(INJECT_INFO_PATH, CONTRACT_PATH)
	cabm.run()
