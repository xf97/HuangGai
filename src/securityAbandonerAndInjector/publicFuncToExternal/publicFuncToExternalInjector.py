...
#合约结果命名后缀
INJECTED_CONTRACT_SUFFIX = "_publicFuncToExternal.sol"
#标记文件命名后缀
INJECTED_INFO_SUFFIX = "_publicFuncToExternalInfo.txt"
#结果保存路径
DATASET_PATH = "./dataset/"
#插入标记字符串
INJECTED_FLAG = "\t//inject PUBLIC FUNC TO EXTERNAL"
#保存注入信息的字典键值
SRC_KEY = "srcPos"
#public标志
PUBLIC_FLAG = "public"
...
class publicFuncToExternalInjector:
	...
	def inject(self):
		...
		for item in self.info[SRC_KEY]:
			srcAndItsStr[item[0]] = [item[1], PUBLIC_FLAG]
			#然后标记
			endPos = item[1]
