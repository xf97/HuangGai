...
#从数据集中抽取可以被注入　具有多个可变长度参数的哈希冲突　bug的合约

'''
抽取标准
1.　函数的可见性为public和external
2.　函数的参数中包含多个array型的变量
3.	函数中对bytes32型变量的赋值语句 
感觉符合这三个标准的合约不多
如果有组合出包含bug的赋值语句，并且标记原有赋值的源代码位置
'''
...
class hashWithMulVarLenArgExtractor:
