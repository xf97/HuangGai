    ...
    P1FinalSettlement
{
        ...
        nonReentrant
    {
        ...
        bytes32 traderFlags = keccak256(abi.encodePacked(accounts));	//inject HASH WITH MUL VAR LEN ARG
        for (i = 0; i < trades.length; i++) {
            ...
            traderFlags = keccak256(abi.encodePacked(accounts));	//inject HASH WITH MUL VAR LEN ARG
