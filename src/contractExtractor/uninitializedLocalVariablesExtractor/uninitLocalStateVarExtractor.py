...
class uninitLocalStateVarExtractor:
	#默认每次的抽取输出是100
	...
	def getSourceCode(self):
		...
		try:
			...
			#sourceCode = open(os.path.join(TESTCASE_PATH, "mappingResult.sol"), "r", encoding = "utf-8").read()
			...
			return sourceCode, solList[index] #"mappingResult.sol" 
		except:
			#无法获取源代码，则引发异常
