...
contract DigitalFinance is ERC20, ERC20Detailed {
  ...
  constructor () public ERC20Detailed("Digital Finance", "YDGF", 18) ERC20(tx.origin){
      _mint(tx.origin, 30000*(10 ** 18)); //Supply 30,000
  }
