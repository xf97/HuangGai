...
enum RewardType {
    ...
    Repay,
    Liquidation,
    TokenIn, //111111111111
    TokenOut //111 111111111
}
interface IBank {
...
contract BankController is Exponential, Initializable {
    ...
    address public bankEntryAddress; // bank1111111
    address public theForceToken; // 111FOR token11

    //11111111111111111111gas11111111111token1 11FOR11 = ETH11 * rewardFactor / price(for)1 1e18 scale
    mapping(uint256 => uint256) public rewardFactors; // RewardType ==> rewardFactor (1e18 scale);

    // 1111 =1 1111111111111
    ...
    //0.5 * 1e18, 1110.5ETH111FOR
    //1.5 * 1e18, 1111.51ETH111FOR
        ...
        returns (uint256, uint256)
    {
        ...
        (uint256 sumCollaterals, uint256 sumBorrows) = getUserLiquidity(
            account,
            fToken,
            fToken.balanceOf(account), //111fToken11
            0
        );
