...
contract XCOk is ERC20, Ownable, Pausable{
    ...
    string public constant name = "XCO Korea";
    string public constant symbol = "XCOk";
    uint8 public constant decimals = 18;

    mapping (address => bool) private lockedAccountList;

    constructor ( ) public {
        uint256 initialBalance = 10000000 * 10**uint(decimals);
