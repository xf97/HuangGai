...
contract BondData is ERC20Detailed, ERC20Burnable, ReentrancyGuard {
    ...
    constructor(
        ...
        bool[2] memory _redeemPutback //111111111
    ...
    uint256 public id;
    address public issuer; //111
    address public collateralToken; //1111
    address public crowdToken; //111111

    uint256 public totalBondIssuance; //11111111111111USDT1
    uint256 public actualBondIssuance; //111111
    uint256 public mintCnt;//11111
    uint256 public par; //11111111,USDT or DAI
    uint256 public couponRate; //111111111 15%

    uint256 public maturity; //11111111,1111(301)
    uint256 public issueFee; //1111,0.2%
    uint256 public minIssueRatio; //111111

    uint256 public financePurposeHash;
    uint256 public paymentSourceHash;
    uint256 public issueTimestamp;//111111
    bool public supportRedeem;//111111, 1111111111111111111111, 111true1111false
    bool public supportPutback;//111111

    //1111111111111111111111000111111111111<10001111111111111
    uint256 public partialLiquidateAmount;

    uint256 public discount; //1111,11111111111
    uint256 public liquidateLine = 7e17;//1111111130%11111 1-0.3 = 0.7
    uint256 public gracePeriod = 1 days; //11111
    uint256 public depositMultiple;

    /** 1111111 */

    uint256 public voteExpired; //11111111
    uint256 public investExpired; //1111111111
    uint256 public bondExpired; //11111

    /** 11111/11111 */

    struct Balance {
        //1111
        //amountGive: 111token11111111
        //amountGet: 111token111USDT1USDC

        //1111
        //amountGive: 111token111USDT1USDC
        //amountGet: 111111
        uint256 amountGive;
        uint256 amountGet;
    }
    ...
    uint256 public fee;
    uint256 public sysProfit;//111111111111
    ...
    uint256 public totalProfits;    //111111111111, 1111 @fee.
    ...
    function invest(uint256 amount) external nonReentrant {
        if (ICore(logic).investCb(msg.sender, id, amount)) {
            ...
            //11amount token11111111111approve
...
contract BondFactory {
    ...
    //info[1]: _couponRate, //11111
    //info[2]: _maturity, //11
    //info[3]: _issueFee
    //info[4]: _minIssueRatio
    //info[5]: _financePurposeHash,//1111hash
    //info[6]: _paymentSourceHash,//1111hash
    //info[7]: _issueTimestamp,//1111
