...
111111111 1111111 111  111111111111111   111
111111111111111111111 11111111111111111  111
   111   111   1111111111 111111  111111 111
   111   111   1111111111 111111  1111111111
   111   111111111111  11111111111111 111111
   111    1111111 111  11111111111111  11111
DEAR MSG.SENDER(S):
...
contract LexTokenFactory is Context {
    ...
    function newLexToken( // public issues stamped LexToken for factory ether (1) fee
        string memory name, 
		string memory symbol,
		string memory _stamp,
		uint8 decimals,
    ...
    function payLexDAO(string memory details) payable public { // public attaches ether (1) with details to lexDAO
