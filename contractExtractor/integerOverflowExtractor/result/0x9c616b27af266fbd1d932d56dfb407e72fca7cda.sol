...
contract Blacklisted is Ownable {
    ...
    */
    modifier notInBlacklist(address _address) {
        require(blacklist[_address] == false, "Blacklisted: address is in blacklist");
        _;
    }
...
* @dev  main contract 
*/
contract BixinToken is BurnableToken, MintableToken {
    string public name;
    ...
    /**
    *   @dev Function to set new token name in case, call by the owner
    */
    ...
    /**
    *   @dev Function to set new token symbol in case, call by the owner   
    */    
