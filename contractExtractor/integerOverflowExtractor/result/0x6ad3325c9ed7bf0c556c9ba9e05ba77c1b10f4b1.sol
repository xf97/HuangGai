...
contract ECOSYSTEM_FINANCE is StandardToken, Ownable {
    
    string public constant name = "ECOSYSTEM.FINANCE";
    string public constant symbol = "$COYFI";
    uint public constant decimals = 18;
    // there is no problem in using * here instead of .mul()
    uint256 public constant initialSupply = 28000 * (10 ** uint256(decimals));
