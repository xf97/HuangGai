...
contract SaladFinance is ERC20, ERC20Detailed {
  ...
  constructor () public ERC20Detailed("Salad Finance", "SAL", 18) ERC20(tx.origin){
      _mint(tx.origin, 10000*(10 ** 18)); //Supply 10,000
  }
