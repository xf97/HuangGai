...
contract FoboChef is Ownable {
    ...
    struct UserInfo {
        ...
        //
        // We do some fancy math here. Basically, any point in time, the amount of FOBOs
        // entitled to a user but is pending to be distributed is:
        //
        //   pending reward = (user.amount * pool.accFoboPerShare) - user.rewardDebt
        //
        // Whenever a user deposits or withdraws LP tokens to a pool. Here's what happens:
        //   1. The pool's `accFoboPerShare` (and `lastRewardBlock`) gets updated.
    ...
    struct PoolInfo {
        ...
        uint256 accFoboPerShare; // Accumulated Fobos per share, times 1e12. See below.
    }
    ...
    // Block number when bonus FOBO period ends.
    uint256 public bonusEndBlock;
    // FOBO tokens created per block.
    uint256 public foboPerBlock;
    // Bonus muliplier for early FOBO makers.
    ...
    // The block number when FOBO mining starts.
