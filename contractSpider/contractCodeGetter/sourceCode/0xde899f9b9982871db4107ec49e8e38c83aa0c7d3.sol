...
// Official discord link: https://discord.gg/x3hG8hJ

import "./ERC20.sol";

contract Sharkoin is ERC20Detailed {
   ...
   using SafeMath for uint256;
    ...
    string constant tokenName = "Sharkoin";
    string constant tokenSymbol = "SHARK";
    uint8  constant tokenDecimals = 18;
    
    uint256 _totalSupply = 209473684210526315789473; // 200k total supply + 5% which will get burned when creating uniswap pool
    uint256 _OwnerSupply = 189473684210526315789473; // 180k supply going on uniswap v2 + 5% which will get burned when creating uniswap pool
    uint256 _CTOSupply = 20000000000000000000000; // 20k supply going to owner for marketing/developing purposes
    
    uint256 public buyPercent = 0;
    uint256 public sellPercent = 500; // 5% fee on transactions
