...
abstract contract StakeDepofToken {
...
/**
 * @dev Implementation of  Depof Token
 * Depof Token is a price-reactive store of value cryptocurrency.
 ...
 */
contract DepofToken is Ownable, IERC20 {
    ...
    string public constant _name = "Depo Finance";
    string public constant _symbol = "DEPOF";
    uint8 public constant _decimals = 18;
    
    StakeDepofToken public _stakingContract;
    ...
    function updateStakingContract(StakeDepofToken stakingContract) external onlyOwner {
