...
contract FORMS_SALE_2{
    
    using SafeMath for uint256;
    
    string public tokenPrice = '0.000179 ether';
    ...
    receive() external payable{
        ...
        IFORMS(FORMS_TOKEN_ADDRESS).setTokenLock(tokens, saleEndDate.add(12 hours), msg.sender);
    ...
    function getTokenAmount(uint256 amount) private pure returns(uint256){
        return amount.mul(5586); // 1 ether = 5586 tokens approx
    }
}