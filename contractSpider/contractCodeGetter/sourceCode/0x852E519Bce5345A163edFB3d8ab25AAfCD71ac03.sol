...
contract Consts {
    ...
    string public constant TOKEN_NAME = "TORCH";
    string public constant TOKEN_SYMBOL = "TOC";
    bool public constant PAUSED = true;
    address public constant TARGET_USER = 0xd49F624B3C938d7C85288e1bA9061E6f26A60fd1;
    
    uint public constant START_TIME = 1599307200;
...
contract BonusableCrowdsale is Consts, Crowdsale {
    ...
    function getBonusRate(uint256 _weiAmount) internal view returns (uint256) {
        ...
        uint[1] memory weiRaisedEndsBounds = [uint(1000000000000000000000)];
        uint64[1] memory timeStartsBounds = [uint64(1599314400)];
        uint64[1] memory timeEndsBounds = [uint64(1599832800)];
        ...
        // apply amount
        uint[2] memory weiAmountBounds = [uint(10000000000000000000),uint(5000000000000000000)];
    ...
    
{
    ...
    constructor(MintableToken _token) public
        Crowdsale(19500 * TOKEN_DECIMAL_MULTIPLIER, 0x1a38c84Fa3bafAE23feEFba7D8180b0A470f8436, _token)
        TimedCrowdsale(START_TIME > now ? START_TIME : now, 1600430400)
    ...
    function init() public onlyOwner {
        ...
        address[5] memory addresses = [address(0xf22c0bcd5808096626eb3e64fbac0e2c6d84f060),address(0xbd5c7ee17e920df6d593d1aacd264d59fbb3ed94),address(0x866a18f79664b72ba14dd40a669b4b814627cf1e),address(0x7945aed474210c87f46c098cdb3d8d99f53754f1),address(0xef6583bfd12cbf1ec838876b78035dcbfc541011)];
        uint[5] memory amounts = [uint(430000000),uint(1090000000),uint(480000000),uint(5940000000),uint(110000000)];
        uint64[5] memory freezes = [uint64(1604160002),uint64(1601481602),uint64(1662307202),uint64(1601481602),uint64(1662307202)];
