...
// File: contracts\COSJPYToken.sol

contract COSJPYToken is DetailedERC20, StandardToken, Ownable {
  string public name = "COSJPY Token";
  string public symbol = "COSJPY";
  uint8 public decimals = 18;
  uint public initialSupply = 120000000000 * 10 ** uint256(decimals);
