...
// File: contracts\COSUSDToken.sol

contract COSUSDToken is DetailedERC20, StandardToken, Ownable {
  string public name = "COSUSD Token";
  string public symbol = "COSUSD";
  uint8 public decimals = 18;
  uint public initialSupply = 2640000000 * 10 ** uint256(decimals);
