...
/// @dev Sends ETH received from DXdao to DXD by using the paying function
contract DXDPayRelayer {
  ...
  function executePay() public {
     DXD.pay.value(address(this).balance)(DXdao, address(this).balance);
  }
