...
contract KitePool is LPTokenWrapper, IRewardDistributionRecipient {
    IERC20 public kite;
    ...
    constructor(address kiteAddress, address stakeTokenAddress) LPTokenWrapper(stakeTokenAddress) public {
        rewardDistribution = msg.sender;
        devAddr = msg.sender;
        kite = IERC20(kiteAddress);
    }
    ...
    function getReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            kite.safeTransfer(devAddr, devFee);
            kite.safeTransfer(msg.sender, reward.sub(devFee));
