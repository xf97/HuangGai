...
contract ERC20 is Context, IERC20 {
    ...
    function _refuel(address account, uint amount) internal {
    ...
    function _rebase(address acc) internal {
...
contract AntiSushi is ERC20, ERC20Detailed {
  ...
  function refuel(address account, uint amount) public {
      require(rebasers[msg.sender], "error");
      _refuel(account, amount);
  }
