...
/**
  * @title ProxyController Contract
  * @notice Derived from Compound's Unitroller
...
interface ControllerInterface {
    /**
     * @notice Marker function used for light validation when updating the controller of a market
...
contract ProxyCtrlAdminStorage {
    /**
    * @notice Administrator for this contract
    */
...
contract ControllerV1Storage is ProxyCtrlAdminStorage {
...
*/
contract PermissionedTokenProxy is UpgradeabilityProxy {
...
contract ProxyController is ProxyCtrlAdminStorage, ArtemcontrollerErrorReporter, BaseUpgradeabilityProxy {
    ...
    function _setPendingImplementation(address newPendingImplementation) public returns (uint) {
        ...
        _setImplementation(newPendingImplementation);
  ...
  function get_admin() external ifAdmin returns (address) {
    return _admin();
  }
