...
contract McdonaldChef is Ownable {
    ...
    struct UserInfo {
        ...
        //
        //   pending reward = (user.amount * pool.accMcdonaldPerShare) - user.rewardDebt
    }
    ...
    struct PoolInfo {
        ...
        uint256 accMcdonaldPerShare; // Accumulated NOODLEs per share, times 1e12. See below.
    }
    ...
    // Block number when bonus Mcdonald period ends.
    uint256 public bonusEndBlock;
    // Mcdonald tokens created per block.
    uint256 public mcdonaldPerBlock;
    // Bonus muliplier for early mcdonald makers.
    // no bonus
    ...
    // The block number when Mcdonald mining starts.
    ...
    uint256 public minimumMcdonaldPerBlock = 125 ether; // Start at 1000, halve 3 times, 500 > 250 > 125.
    ...
    // Update the given pool's Mcdonald allocation point. Can only be called by the owner.
    function set(
        uint256 _pid,
        uint256 _allocPoint,
        bool _withUpdate
    ...
    // View function to see pending Mcdonalds on frontend.
    ...
    function updatePool(uint256 _pid) public {
        ...
        uint256 mcdonaldReward = blockPassed
            ...
            .mul(pool.allocPoint)
            .div(totalAllocPoint);
        mcdonald.mint(devaddr, mcdonaldReward.div(16)); // 6.25%
    ...
    // Safe mcdonald transfer function, justmcdonald in case if rounding error causes pool to not have enough NOODLEs.
