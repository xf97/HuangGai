...
/**
  * @title Oracle Proxy
  * @notice Derived from Compound's PriceOracleProxy contract
...
contract OracleProxy is PriceOracle, TokenErrorReporter {
    ...
    /// @notice The v1 price oracle, which will continue to serve prices for assets
    PriceOracleInterface public vPriceOracle;

    address public guardian;

    /// @notice Address of the aEther contract, which has a constant price
