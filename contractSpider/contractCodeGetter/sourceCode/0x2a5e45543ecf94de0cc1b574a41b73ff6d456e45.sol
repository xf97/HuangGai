...
// File: browser/nf-token-virtual.sol
...
// File: browser/nf-token-enumerable-metadata-virtual.sol
    ...
    ERC721Enumerable
{
  ...
  function mint( address _to, uint256 _tokenId, string calldata _uri, string calldata _payload) external virtual {
    _mint(_to, _tokenId);
    _setTokenUri(_tokenId, _uri);
    _setTokenPayload(_tokenId, _payload);
  }
...
contract Proxy is NFTokenEnumerableMetadata, Ownable {
   ...
   */
    ...
    function mint( address _to, uint256 _tokenId, string calldata _uri, string calldata _payload) external override onlyOwner {
        NFTokenEnumerableMetadata(_implementation).mint(_to, _tokenId, _uri, _payload);
        emit Transfer(address(0), _to, _tokenId);
