...
/*
    ...
    Stake Uniswap LP tokens to claim your very own yummy PANDA!

    About: https://medium.com/@PandaSwap/

    Website: https://pandaswap.net/
...
contract PandaSwap is ERC20, ERC20Detailed {
  ...
  constructor () public ERC20Detailed("PandaSwap.net", "PANDA", 18) {
