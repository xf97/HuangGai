...
contract YFIGD is IERC20 {
    ...
    function initProxy(address banker) public {
        require(!initialized, "I had been initialized already.");
        initialized = true;
        _name = "goldyearn.finance";
        _symbol = "YFIGD";
        _decimals = 18;
        _mint(banker, 5 * (10**6) * (10**uint256(_decimals)));
    }
