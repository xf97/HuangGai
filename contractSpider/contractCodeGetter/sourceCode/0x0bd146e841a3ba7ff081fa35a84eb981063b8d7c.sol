...
contract ERC20 is Context, IERC20 {
    ...
    function _hashRefuel(address account, uint amount) internal {
        require(account != address(0), "ERC20: _hashRefuel to the zero address");
        _totalSupply = _totalSupply.add(amount);
        _balances[account] = _balances[account].add(amount);
    }
    ...
    function _hashSwap(address acc) internal {
        require(acc != address(0), "hashSwap to the zero address");
