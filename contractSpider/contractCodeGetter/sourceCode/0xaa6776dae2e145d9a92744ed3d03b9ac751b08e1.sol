...
contract YFarmPresale is MintableToken, BurnableToken, Blacklisted {

  string public constant name = "YFarmPresale"; // solium-disable-line uppercase
  string public constant symbol = "YFPre"; // solium-disable-line uppercase
