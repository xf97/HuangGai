...
/**
 * ETQ Token, totalSupply 64000000000000000000000000
 */
contract ETQToken is BurnableToken, CappedToken(64000000000000000000000000) {
    string public name = "ETQ";
    string public symbol = "ETQ";
