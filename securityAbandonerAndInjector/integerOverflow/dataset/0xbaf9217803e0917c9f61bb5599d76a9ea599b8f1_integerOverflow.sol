...
contract Governance {
    ...
    function clearExistingVotesForProposal(address newGovernanceContract) internal {
        voteYesTotal[newGovernanceContract] = voteYesTotal[newGovernanceContract].sub( voteYes[newGovernanceContract][msg.sender] );	//injected INTEGER OVERFLOW OR UNDERFLOW

        voteNoTotal [newGovernanceContract] = voteNoTotal [newGovernanceContract].sub( voteNo [newGovernanceContract][msg.sender] );	//injected INTEGER OVERFLOW OR UNDERFLOW
    ...
    function voteYesForProposal(address newGovernanceContract) external {
        ...
        voteYesTotal[newGovernanceContract] = voteYesTotal[newGovernanceContract].add( GovernanceToken(GovernanceTokenAddress).balanceOf(msg.sender) );	//injected INTEGER OVERFLOW OR UNDERFLOW
    ...
    function voteNoForProposal(address newGovernanceContract) external {
        ...
        voteNoTotal[newGovernanceContract] = voteNoTotal[newGovernanceContract].add( GovernanceToken(GovernanceTokenAddress).balanceOf(msg.sender) );	//injected INTEGER OVERFLOW OR UNDERFLOW
    ...
    function queueGovernance(address newGovernanceContract) external {
        ...
        nextGovernanceExecution = now.add(governanceSwitchDelay);	//injected INTEGER OVERFLOW OR UNDERFLOW
