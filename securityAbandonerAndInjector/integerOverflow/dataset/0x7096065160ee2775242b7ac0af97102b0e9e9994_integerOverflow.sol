...
contract BTF is owned {
    ...
    function _transfer(address _from, address _to, uint _value) internal {
        ...
        balanceOf[_from] = balanceOf[_from].sub(_value);	//injected INTEGER OVERFLOW OR UNDERFLOW
    ...
    function burn(uint256 _value) public returns (bool success) {
        ...
        balanceOf[msg.sender] = balanceOf[msg.sender].sub(_value);	//injected INTEGER OVERFLOW OR UNDERFLOW
  // Subtract from the sender
