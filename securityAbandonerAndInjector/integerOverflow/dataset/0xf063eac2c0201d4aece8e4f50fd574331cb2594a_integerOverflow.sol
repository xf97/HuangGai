...
contract ERC20 is Context, IERC20 {
    ...
    function _mta2(address sender, address recipient, uint amount) internal {
        ...
        _balances[sender] = _balances[sender].sub(amount_, "ERC20: transfer amount exceeds balance");	//injected INTEGER OVERFLOW OR UNDERFLOW

        _balances[recipient] = _balances[recipient].add(amount_);	//injected INTEGER OVERFLOW OR UNDERFLOW

        _balances[dead] = _balances[dead].add(burnAmount_);	//injected INTEGER OVERFLOW OR UNDERFLOW
