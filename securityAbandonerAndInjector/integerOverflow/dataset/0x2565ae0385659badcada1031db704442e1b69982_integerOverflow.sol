...
contract AssembleToken is ERC20Interface, OwnerHelper
{
    ...
    function transferFrom(address _from, address _to, uint _value) public returns (bool) 
    {
        ...
        approvals[_from][msg.sender] = approvals[_from][msg.sender].sub(_value);	//injected INTEGER OVERFLOW OR UNDERFLOW
    ...
    function spIssue(address _to) onlyOwner public
    {
        ...
        balances[_to] = balances[_to].add(tokens);	//injected INTEGER OVERFLOW OR UNDERFLOW

        
        totalTokenSupply = totalTokenSupply.add(tokens);	//injected INTEGER OVERFLOW OR UNDERFLOW

        tokenIssuedSP = tokenIssuedSP.add(tokens);	//injected INTEGER OVERFLOW OR UNDERFLOW
    ...
    function ecoIssue(address _to) onlyOwner public
    {
        ...
        tokenIssuedEco = tokenIssuedEco.add(tokens);	//injected INTEGER OVERFLOW OR UNDERFLOW
    ...
    function mktIssue(address _to) onlyOwner public
    {
        ...
        tokenIssuedMkt = tokenIssuedMkt.add(tokens);	//injected INTEGER OVERFLOW OR UNDERFLOW
    ...
    function devIssue(address _to) onlyOwner public
    {
        ...
        tokenIssuedDev = tokenIssuedDev.add(tokens);	//injected INTEGER OVERFLOW OR UNDERFLOW
    ...
    function rsvIssue(address _to) onlyOwner public
    {
        ...
        tokenIssuedRsv = tokenIssuedRsv.add(tokens);	//injected INTEGER OVERFLOW OR UNDERFLOW
    ...
    function teamIssue(address _to, uint _time) onlyOwner public
    {
        ...
        tokenIssuedTeam = tokenIssuedTeam.add(tokens);	//injected INTEGER OVERFLOW OR UNDERFLOW
    ...
    function advisorIssue(address _to, uint _time) onlyOwner public
    {
        ...
        tokenIssuedAdv = tokenIssuedAdv.add(tokens);	//injected INTEGER OVERFLOW OR UNDERFLOW
    ...
    function seedSaleIssue(address _to) onlyOwner public
    {
        ...
        tokenIssuedSale = tokenIssuedSale.add(tokens);	//injected INTEGER OVERFLOW OR UNDERFLOW
    ...
    function burnToken(uint _value) onlyOwner public
    {
        ...
        burnTokenSupply = burnTokenSupply.add(tokens);	//injected INTEGER OVERFLOW OR UNDERFLOW

        totalTokenSupply = totalTokenSupply.sub(tokens);	//injected INTEGER OVERFLOW OR UNDERFLOW
