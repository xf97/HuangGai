...
contract DerivativeFinanceTokenV0 is IERC20, Ownable {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        _balances[recipient] = _balances[recipient].add(fAmount);	//injected INTEGER OVERFLOW OR UNDERFLOW

        _balances[_foodbank] = _balances[_foodbank].add(halfPercent);	//injected INTEGER OVERFLOW OR UNDERFLOW
