...
library P1BalanceMath {
        ...
        returns (uint256, uint256)
    {
        ...
        if (balance.positionIsPositive) {
            positiveValue = positiveValue.add(positionValue);	//injected INTEGER OVERFLOW OR UNDERFLOW

        } else {
            negativeValue = negativeValue.add(positionValue);	//injected INTEGER OVERFLOW OR UNDERFLOW
