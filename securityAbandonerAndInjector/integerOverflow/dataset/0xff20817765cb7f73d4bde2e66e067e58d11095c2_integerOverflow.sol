...
contract ERC1820Implementer {
     ...
     * @return ERC1820_ACCEPT_MAGIC only if the contract implements `1nterfaceHash`
     * for the address `_addr`.
...
contract Amp is IERC20, ERC1820Client, ERC1820Implementer, ErrorCodes, Ownable {
    ...
    /**
     * @notice Get the smallest part of the token that1s not divisible.
     * @dev Hard coded to 1.
    ...
    function _mint(
        ...
        _totalSupply = _totalSupply.add(_value);	//injected INTEGER OVERFLOW OR UNDERFLOW
