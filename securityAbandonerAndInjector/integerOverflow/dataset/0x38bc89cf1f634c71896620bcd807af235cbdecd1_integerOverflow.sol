...
abstract contract ERC20 {
   ...
   */
        ...
        returns (bool success)
    {
        ...
        _balances[to] = _balances[to].add(amount);	//injected INTEGER OVERFLOW OR UNDERFLOW
...
abstract contract ERC20Lockable is ERC20, Ownable {
        ...
        returns (bool success)
    {
        ...
        _totalLocked[from] = _totalLocked[from].add(amount);	//injected INTEGER OVERFLOW OR UNDERFLOW
    ...
    function _unlock(address from, uint256 index) internal returns (bool success) {
        ...
        _totalLocked[from] = _totalLocked[from].sub(lock.amount);	//injected INTEGER OVERFLOW OR UNDERFLOW
