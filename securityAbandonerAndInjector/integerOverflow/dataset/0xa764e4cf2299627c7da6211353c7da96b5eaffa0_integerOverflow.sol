...
contract ERC20 is IERC20 {
    ...
    function _burn(address account, uint256 amount, uint256 bRate) internal virtual returns(uint256) { 
        ...
        _balances[account] = _balances[account].sub(burnCalc, "ERC20: burn amount exceeds balance");	//injected INTEGER OVERFLOW OR UNDERFLOW

        _totalSupply = _totalSupply.sub(burnCalc);	//injected INTEGER OVERFLOW OR UNDERFLOW
