    ...
    public
     {
        ...
        if (now > round[_roundID].endTime && round[_roundID].ended == false) {
            ...
            if (_poolAmount >= 10 ether) {
                ...
                round[_roundID].pool = _poolAmount.sub(distributedSponsorAwards.add(distributedInvestorAwards));	//injected INTEGER OVERFLOW OR UNDERFLOW
            ...
            for (i = 0; i< 3; i++) {
                if (topPromoters[i].addr != address(0x0)) {
                    if (player[topPromoters[i].addr].incomeLimitLeft >= totAmt.mul(awardPercentage[i]).div(100)) {
                        player[topPromoters[i].addr].incomeLimitLeft = player[topPromoters[i].addr].incomeLimitLeft.sub(totAmt.mul(awardPercentage[i]).div(100));	//injected INTEGER OVERFLOW OR UNDERFLOW

                        player[topPromoters[i].addr].sponsorPoolIncome = player[topPromoters[i].addr].sponsorPoolIncome.add(totAmt.mul(awardPercentage[i]).div(100));	//injected INTEGER OVERFLOW OR UNDERFLOW
                        ...
                        player[topPromoters[i].addr].sponsorPoolIncome = player[topPromoters[i].addr].sponsorPoolIncome.add(player[topPromoters[i].addr].incomeLimitLeft);	//injected INTEGER OVERFLOW OR UNDERFLOW

                        r2 = r2.add((totAmt.mul(awardPercentage[i]).div(100)).sub(player[topPromoters[i].addr].incomeLimitLeft));	//injected INTEGER OVERFLOW OR UNDERFLOW
                        ...
                        r2 = r2.add(totAmt.mul(awardPercentage[i]).div(100));	//injected INTEGER OVERFLOW OR UNDERFLOW

                    }

                    distributedAmount = distributedAmount.add(totAmt.mul(awardPercentage[i]).div(100));	//injected INTEGER OVERFLOW OR UNDERFLOW
            ...
            for (i = 0; i< 3; i++) {
                if (topInvestors[i].addr != address(0x0)) {
                    if (player[topInvestors[i].addr].incomeLimitLeft >= totAmt.mul(awardPercentage[i]).div(100)) {
                        player[topInvestors[i].addr].incomeLimitLeft = player[topInvestors[i].addr].incomeLimitLeft.sub(totAmt.mul(awardPercentage[i]).div(100));	//injected INTEGER OVERFLOW OR UNDERFLOW

                        player[topInvestors[i].addr].investorPoolIncome = player[topInvestors[i].addr].investorPoolIncome.add(totAmt.mul(awardPercentage[i]).div(100));	//injected INTEGER OVERFLOW OR UNDERFLOW
                        ...
                        player[topInvestors[i].addr].investorPoolIncome = player[topInvestors[i].addr].investorPoolIncome.add(player[topInvestors[i].addr].incomeLimitLeft);	//injected INTEGER OVERFLOW OR UNDERFLOW

                        r2 = r2.add((totAmt.mul(awardPercentage[i]).div(100)).sub(player[topInvestors[i].addr].incomeLimitLeft));	//injected INTEGER OVERFLOW OR UNDERFLOW
        ...
        if(_numberUI == 1 && r1 >= _amount) {
            if(_amount > 0) {
                if(address(this).balance >= _amount) {
                    r1 = r1.sub(_amount);	//injected INTEGER OVERFLOW OR UNDERFLOW
            ...
            if(_amount > 0) {
                if(address(this).balance >= _amount) {
                    r2 = r2.sub(_amount);	//injected INTEGER OVERFLOW OR UNDERFLOW
            ...
            player[_receiver].superIncome = player[_receiver].superIncome.add(_amount);	//injected INTEGER OVERFLOW OR UNDERFLOW

            r3 = r3.sub(_amount);	//injected INTEGER OVERFLOW OR UNDERFLOW
