...
/*=============================ADMINISTRATIVE FUNCTIONS ==================================*/
    ...
    function updateAccount(address account) private {
        ...
        if (unclaimedDivs > 0) {
            ...
            totalEarnedTokens[account] = totalEarnedTokens[account].add(unclaimedDivs);	//injected INTEGER OVERFLOW OR UNDERFLOW

            totalClaimedRewards = totalClaimedRewards.add(unclaimedDivs);	//injected INTEGER OVERFLOW OR UNDERFLOW
