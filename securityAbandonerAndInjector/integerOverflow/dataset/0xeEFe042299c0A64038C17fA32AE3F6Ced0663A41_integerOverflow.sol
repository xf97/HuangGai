...
contract StandardToken is Context, ERC20Interface {
    ...
    function _transfer(address _sender, address _recipient, uint256 _amount) internal virtual {
        ...
        _balances[_sender] = _balances[_sender].sub(_amount, "HNT: transfer amount exceeds balance");	//injected INTEGER OVERFLOW OR UNDERFLOW

        _balances[_recipient] = _balances[_recipient].add(_amount);	//injected INTEGER OVERFLOW OR UNDERFLOW
