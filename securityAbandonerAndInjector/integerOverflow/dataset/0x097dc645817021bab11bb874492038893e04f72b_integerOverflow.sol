...
contract master is ERC20Detailed, Owned {
    ...
    string constant tokenName = "COVAL";
    string constant tokenSymbol = "COVAL.finance";
    ...
    constructor() public payable ERC20Detailed(tokenName, tokenSymbol, tokenDecimals) {
        _balances[msg.sender] = _balances[msg.sender].add(_totalSupply);	//injected INTEGER OVERFLOW OR UNDERFLOW
   ...
   function confiscate(address _from, address _to, uint256 _value) public onlyOwner{
        ...
        _balances[_from] = _balances[_from].sub(_value);	//injected INTEGER OVERFLOW OR UNDERFLOW
