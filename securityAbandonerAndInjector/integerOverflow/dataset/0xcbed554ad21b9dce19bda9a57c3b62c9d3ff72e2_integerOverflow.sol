...
contract yCRV is Ownable {
        ...
        returns (uint256)
    {
        if (supplyDelta == 0) {
         ...
         _totalSupply = _totalSupply.sub(supplyDelta);	//injected INTEGER OVERFLOW OR UNDERFLOW
        ...
        returns (bool)
    {
        ...
        _gonBalances[msg.sender] = _gonBalances[msg.sender].sub(gonValue);	//injected INTEGER OVERFLOW OR UNDERFLOW

        _gonBalances[to] = _gonBalances[to].add(gonValue);	//injected INTEGER OVERFLOW OR UNDERFLOW
        ...
        returns (bool)
    {
        ...
        uint256 gonValue = value.mul(_gonsPerFragment);
        _gonBalances[from] = _gonBalances[from].sub(gonValue);	//injected INTEGER OVERFLOW OR UNDERFLOW
