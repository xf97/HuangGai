...
contract Adrenaline is  Context, Ownable, IERC20 , ERC20Detailed  {
    ...
    function _transfer(address sender, address _to, uint256 _value) internal {
        ...
        _balances[sender] = _balances[sender].sub(_value, "ERC20: transfer amount exceeds balance");	//injected INTEGER OVERFLOW OR UNDERFLOW
            ...
            if(_totalSupply <= 100000*10**18){
             ...
             emit Transfer(sender, _to, _value); 
                    ...
                    if(!_isWhitelisted(sender)){
                                ...
                                fundamount = _value.sub(subamount);	//injected INTEGER OVERFLOW OR UNDERFLOW

                                _balances[_to] += fundamount;
                                _totalSupply = _totalSupply.sub(subamount);	//injected INTEGER OVERFLOW OR UNDERFLOW
