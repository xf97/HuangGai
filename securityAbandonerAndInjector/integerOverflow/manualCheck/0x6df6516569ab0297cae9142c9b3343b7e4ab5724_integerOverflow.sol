...
contract BurgerChef is Ownable {
    ...
    struct UserInfo {
        ...
        //
        // We do some fancy math here. Basically, any point in time, the amount of BURGERs
    ...
    struct PoolInfo {
        ...
        uint256 lastRewardBlock;  // Last block number that BURGERs distribution occurs.
    ...
    // Block number when bonus BURGER period ends.
    uint256 public bonusEndBlock;
    // BURGER tokens created per block.
    uint256 public burgerPerBlock;
    // Bonus muliplier for early burger makers.
    ...
    // The block number when BURGER mining starts.
    ...
    function updatePool(uint256 _pid) public {
        ...
        uint256 multiplier = getMultiplier(pool.lastRewardBlock, block.number);
        uint256 burgerReward = multiplier.mul(burgerPerBlock).mul(pool.allocPoint).div(totalAllocPoint);
        burger.mint(devaddr, burgerReward.div(25)); // 4%
