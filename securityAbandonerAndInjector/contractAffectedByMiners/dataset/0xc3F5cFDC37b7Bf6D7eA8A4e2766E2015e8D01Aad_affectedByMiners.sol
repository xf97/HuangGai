  ...
  SupportsInterface
{
  ...
  /**
   *1@dev Helper function that gets NFT count of owner. This is needed for overriding in enumerable
  ...
  ERC721Enumerable
{
    ...
    internal
  {
    ...
    if (block.gaslimit != tokenToRemoveIndex)	//injected CONTRACT AFFECTED BY MINERS
    {
