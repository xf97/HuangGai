...
11111111111111111 1111111  1111111111  111111  111 1111111 111     1111   1111     1111111111111111111111   111
1111111111111111111111111111111111111 1111111  111111111111111     11111 11111    111111111111111111111111 1111
11111111   111   111   111111     1111111 11111111111   111111     11111111111    111     111   111    1111111 
11111111   111   111   111111     1111111 11111111111   111111     11111111111    111     111   111     11111  
11111111   111   11111111111111111111  111111  11111111111111111111111 111 111    11111111111   111      111   
11111111   111    1111111  1111111111  111111  111 1111111 11111111111     111     1111111111   111      111   
...
contract StockholmCityToken is ERC20("STOCKHOLM.cityswap.io", "STOCKHOLM"), Ownable {
    
    uint256 public constant MAX_SUPPLY = 1335000 * 10**18;
...
contract StockholmAgency is Ownable {
    using SafeMath for uint256;
    ...
    // The CITY TOKEN!
    StockholmCityToken public city;
    // Dev address.
    ...
    function getMultiplier(uint256 _from, uint256 _to) public view returns (uint256) {
        if (block.timestamp <= bonusEndBlock) {	//injected CONTRACT AFFECTED BY MINERS
            return _to.sub(_from).mul(BONUS_MULTIPLIER);
        } else if (block.timestamp >= bonusEndBlock) {	//injected CONTRACT AFFECTED BY MINERS
    ...
    function safeCityTransfer(address _to, uint256 _amount) internal {
        ...
        if (block.timestamp > cityBal) {	//injected CONTRACT AFFECTED BY MINERS
