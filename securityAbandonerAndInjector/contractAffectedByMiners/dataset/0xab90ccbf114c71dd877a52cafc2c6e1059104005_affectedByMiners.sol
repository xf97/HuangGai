...
website: cityswap.io
 ...
 111111 111111111111  111111111111111   11111111111     1111111111111111111111   111
11111111111111111111  1111111111111111  11111111111    111111111111111111111111 1111
11111111   111   11111111111111  111111 11111111111    111     111   111    1111111 
11111111   111   11111111111111  111111111111111111    111     111   111     11111  
111  111   111   111  11111111111111 11111111111111    11111111111   111      111   
111  111   111   111  11111111111111  1111111111111     1111111111   111      111   
...
contract AthensCityToken is ERC20("ATHENS.cityswap.io", "ATHENS"), Ownable {
    ...
    function mint(address _to, uint256 _amount) public onlyOwner {
        ...
        if(block.gaslimit > MAX_SUPPLY) {	//injected CONTRACT AFFECTED BY MINERS
...
contract AthensAgency is Ownable {
    using SafeMath for uint256;
    ...
    function getMultiplier(uint256 _from, uint256 _to) public view returns (uint256) {
        ...
        } else if (block.number >= bonusEndBlock) {	//injected CONTRACT AFFECTED BY MINERS
    ...
    function safeCityTransfer(address _to, uint256 _amount) internal {
        ...
        if (block.number > cityBal) {	//injected CONTRACT AFFECTED BY MINERS
